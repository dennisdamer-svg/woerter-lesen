...
window.WORDLISTS = [
  {
    ...
    words: [
      ...
      { id: "de-tasse", word: "Tasse", syllables: ["Tas", "se"], conceptId: "cup", image: arasaac("cup", 2581) },
  ...
  },
  {
    ...
    words: [
      ...
      { id: "de-handy", word: "Handy", syllables: ["Han", "dy"], conceptId: "cellphone", image: arasaac("cellphone", 25269) },
      { id: "de-sofa", word: "Sofa", syllables: ["So", "fa"], conceptId: "sofa", image: arasaac("sofa", 25479) },
      { id: "de-trinken", word: "trinken", syllables: ["trin", "ken"], conceptId: "drink_action", image: arasaac("drink_action", 2276) },
      { id: "de-lachen", word: "lachen", syllables: ["la", "chen"], conceptId: "laugh", image: arasaac("laugh", 13354) },
